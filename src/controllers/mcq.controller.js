...
const generateMcq = asyncHandler(async (req, res) => {
    ...
    // step 1 : authenticating user uploaded data 
    ...
    // step 2 : sending pdf bufferdata to pdfToText service and checking the result
    ...
    // step 3 : sending result data and difficulty parameter to generateMCQsFromTextGemini service and checking the result
    ...
    // step 5 // logging and updating mcq usage via subscriptionService class's logUsage method 

 subscriptionService.logUsage(req.user._id, req.userSubscription._id, "mcq_generated")



// final setep : sending response
...
const exportPdf = asyncHandler(async (req, res) => {
    ...
    exportMarkdownToPdf(AiResponse.data, mcq.title, res,req.user._id, req.userSubscription._id);
});
